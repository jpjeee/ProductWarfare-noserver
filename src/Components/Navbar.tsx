...
const Navbar:React.FC= ()=> {
  ...
  return (
    <div className='navbar-full' >
        <img src={Mainlogo} className='mainlogo' alt='logo image' onClick={()=>{window.location.reload()}}></img>
        <div className='parent-item'>
        <li className='navbar-Item' id='home' onClick={()=>{window.location.reload()}}>HOME</li>
